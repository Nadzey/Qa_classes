...
//     }
// }
/////////////////////вывести букву или с цифру (s) определенное число раз (n)
// let n = 31;
// let s = 'Lo'; 
// let newStr = "";
//     for(i = 0; i < n; i++){
...
////////////////////// человек прыгнул с крыши, когда этаж выше 6, человек часто умирает в одно мгновение; Когда пол меньше или равен 6, человек не сразу умрет, он будет кричать
...
//       strictEqual = strictEqual += "Aa~ " 
//       }
//       console.log(`${strictEqual}Pa! Aa!`);
//     }
//     else {
//       for (let i = 1; i < floor; i++){
//       strictEqual = strictEqual += "Aa~ " 
//       }
//       console.log(`${strictEqual}Pa!`);
//     }
///////////////////////////////////////////считаем, сколько убыло, сколько прибыло в аррай
...
var number = function(busStops){
  ...
  let peoplOf = 0;
   ...
   for(let i = 0; i < busStops.length; i++){
    pepolOn = pepolOn + busStops[i][0]
    peoplOf = peoplOf + busStops[i][1]
     
     
  }
     
    console.log(pepolOn - peoplOf);
    }
